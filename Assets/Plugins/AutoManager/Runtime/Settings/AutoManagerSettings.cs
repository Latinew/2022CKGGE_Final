...
{
    //[CreateAssetMenu(fileName = "AutoManagerSettings", menuName = "Settings/AutoManager", order = 0)]
    public class AutoManagerSettings : ScriptableObject
    {
        ...
        [BoxGroup("Managers")] [SerializeField, ReorderableList, TypeDropDown(typeof(Manager))]
        protected string[] excludedManagers;

        [BoxGroup("Debug")] [SerializeField] protected bool showDebugCustomManager = true;
