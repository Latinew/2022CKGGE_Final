...
namespace ShaderGraphHotKey
{
               ...
               try 
                {
                    ...
                    // IMGUIContainer screenshotButton = new IMGUIContainer(() =>
                    // {
                    ...
                    // });
                    //
                    // screenshotButton.name = "Screenshot-Btn";
                    //
                    // screenshotButton.style.alignSelf = Align.FlexEnd;
                    // screenshotButton.style.left = -460;
                    //
                    // VisualElement screenShotElement =
                    //     _graphView.parent.parent.ElementAt(0).Q<VisualElement>("Screenshot-Btn");
                    //
                    // if (screenShotElement == null)
                    //     _graphView.parent.parent.ElementAt(0).Add(screenshotButton);
                }
                catch (Exception)
                {
                }
 ...
 field.hierarchy[0].hierarchy[0].hierarchy[0].hierarchy[0].hierarchy[0].hierarchy[0];
#elif UNITY_2021 || UNITY_2020_3
            VisualElement textInput = field.ElementAt(0);
#endif
